...
Los tests van con los modelos: `unique`, `not_null` y `relationships` en los YAML, más cinco
tests singulares en SQL (grano único de dos hechos, vigencias de `dim_pozo` sin solapamiento,
arena por etapa no negativa y una reconciliación de la producción 2024 contra silver). Son 82
